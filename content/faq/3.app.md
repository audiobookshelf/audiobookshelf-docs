...
| ---------------------------- | ----------- | ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| iOS                          | AudioBooth | https://github.com/AudioBooth/AudioBooth   | AudioBooth is a free, open source, native iOS app with a familiar interface, designed specifically for AudioBookShelf.                  |
