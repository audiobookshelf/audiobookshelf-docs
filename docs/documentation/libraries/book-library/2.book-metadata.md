...
There are many GUI programs that already exist which can also help with fixing an audio file. Some examples are `audacity`, `foobar2000`, `audiobookconverter`, among many others.
