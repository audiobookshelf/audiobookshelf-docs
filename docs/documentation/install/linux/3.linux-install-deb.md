...
- You cannot load a backup from another installation method after installation without losing progress. Use the [Docker installation](/docs/documentation/install/docker) if you plan to switch drives or OS.
